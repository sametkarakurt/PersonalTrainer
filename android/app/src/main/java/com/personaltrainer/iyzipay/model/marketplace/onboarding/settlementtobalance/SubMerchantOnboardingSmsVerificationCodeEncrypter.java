...
import com.personaltrainer.iyzipay.model.marketplace.onboarding.settlementtobalance.exception.SubMerchantOnboardingCryptoEncryptException;
import com.personaltrainer.iyzipay.model.marketplace.onboarding.settlementtobalance.exception.SubMerchantOnboardingInvalidSaltException;
import com.personaltrainer.iyzipay.model.marketplace.onboarding.settlementtobalance.exception.SubMerchantOnboardingInvalidSecretKeyException;
import com.personaltrainer.iyzipay.model.marketplace.onboarding.settlementtobalance.exception.SubMerchantOnboardingInvalidSmsVerificationCode;
...
public class SubMerchantOnboardingSmsVerificationCodeEncrypter {
    ...
    private static void validateSmsVerificationCode(String verificationCode) {
        if (StringUtils.isBlank(verificationCode)) {
            throw new com.personaltrainer.iyzipay.model.marketplace.onboarding.settlementtobalance.exception.SubMerchantOnboardingInvalidSmsVerificationCode("SMS verification code can not be empty or null");
        }
