...
import com.personaltrainer.iyzipay.exception.HttpClientException;
...
public class HttpClient {
    ...
    private static final com.personaltrainer.iyzipay.IyzipaySSLSocketFactory socketFactory = IyzipaySSLSocketFactory.getInstance();
    ...
    private <T> T exchange(String url, Proxy proxy, HttpMethod httpMethod, Map<String, String> headers, Object request, Class<T> responseType) {
        ...
        try {
            ...
            throw new com.personaltrainer.iyzipay.exception.HttpClientException(e.getMessage(), e);
        }
    }
