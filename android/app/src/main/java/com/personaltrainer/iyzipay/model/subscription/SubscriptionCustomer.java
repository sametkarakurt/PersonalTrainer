...
import com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionCustomerData;
import com.personaltrainer.iyzipay.request.subscription.CreateSubscriptionCustomerRequest;
import com.personaltrainer.iyzipay.request.subscription.UpdateSubscriptionCustomerRequest;

public class SubscriptionCustomer extends IyzipayResource {

    @SerializedName("data")
    private com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionCustomerData subscriptionCustomerData;
    ...
    public com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionCustomerData getSubscriptionCustomerData() {
