...
import com.personaltrainer.iyzipay.request.CreateCardRequest;
import com.personaltrainer.iyzipay.request.DeleteCardRequest;
...
public class Card extends IyzipayResource {
    ...
    public static Card create(CreateCardRequest request, Options options) {
        return com.personaltrainer.iyzipay.HttpClient.create().post(options.getBaseUrl() + "/cardstorage/card",
