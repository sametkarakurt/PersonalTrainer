...
import com.personaltrainer.iyzipay.exception.FileEncodingException;
...
public final class FileBase64Encoder {
    ...
    public static String encode(String filePath) {
        ...
        try {
            ...
            throw new com.personaltrainer.iyzipay.exception.FileEncodingException("File content couldn't be read", e);
        } finally {
