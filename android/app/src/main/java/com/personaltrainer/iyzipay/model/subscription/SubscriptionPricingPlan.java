...
import com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionPricingPlanData;
import com.personaltrainer.iyzipay.request.subscription.CreateSubscriptionPricingPlanRequest;
import com.personaltrainer.iyzipay.request.subscription.UpdateSubscriptionPricingPlanRequest;

public class SubscriptionPricingPlan extends IyzipayResource {

    @SerializedName("data")
    private com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionPricingPlanData subscriptionPricingPlanData;
    ...
    public com.personaltrainer.iyzipay.model.subscription.resource.SubscriptionPricingPlanData getSubscriptionPricingPlanData() {
